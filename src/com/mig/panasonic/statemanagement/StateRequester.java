...
/**
 * This singleton class acts as to receive StateRequests and broadcast them
 * to all registered listeners.
 * 
 * Any object that generates an event that may require an application state change
 * calls the requestStateChange method passing through a bundle defining the event
