...
public class FragmentHandler implements IGUIStateChangeNotifierListener {
    ...
    public FragmentHandler(IFragmentTranstionManager transactionManager) {
        ...
        GUIStateChangeNotifier.getInstance().registerListener(this);
    }
    ...
    public void notify(GUI_STATE newState, GUIStateId id, GUIStateData data) {
        ...
        switch (newState) {
        /*
         * commented out for test rig use - only has Fragment 1 and 2 case BACK: this.goBack(id, data); break; case SHOW_MAIN_CAROUSEL:
         * this.showMainCarousel(id, data); break; case SHOW_DETAIL: this.showDetail(id, data); break; case SHOW_LIST: this.showList(id, data); break;
         * case SHOW_NEWS: this.showNews(id, data); break; case SHOW_TELEVISION: this.showTelevision(id, data); break; case SHOW_WEB: this.showWeb(id,
         * data); break; case SHOW_WELCOME: this.showWelcome(id, data); break; case SHOW_USER_PREFERENCES: this.showUserPreferences(id, data); break;
         * case SHOW_APP_PREFERENCES: this.showAppPreferences(id, data); break; case SHOW_ACTION: this.showAction(id, data); break; case SHOW_BASKET:
         * this.showBasket(id, data); break; case SHOW_DIALOG: this.showDialog(id, data); break; case SHOW_XPHONE: this.showXPhone(id, data); break;
         */
            case FRAGMENT1:
